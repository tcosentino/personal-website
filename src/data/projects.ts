...
export const projects: Project[] = [
  {
    ...
    description: 'Contuit was a no-code workflow automation platform purpose-built for Managed Service Providers. Co-founded in 2017, the platform grew from zero to 300+ customers with 50+ integrations before being acquired by Ntiva in 2024. The platform enabled MSPs to automate complex multi-step workflows across their tool stack without writing code.',
    highlights: [
      'Grew from zero to acquisition, serving 300+ customers',
      'Built distributed orchestration engine processing 25,000+ operations per minute',
